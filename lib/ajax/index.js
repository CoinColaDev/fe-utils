...
exports.setup = exports.get = exports.post = void 0;
...
var base = function base(method, dataMethod, contentType) {
  return function (url) {
...
var post = base('post', 'send', 'form');
exports.post = post;
var get = base('get', 'query', 'json');
exports.get = get;
